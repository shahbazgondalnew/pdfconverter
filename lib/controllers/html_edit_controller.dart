...
import 'html_to_pdf_controller.dart';

class HtmlEditController extends GetxController {
  late final String documentId;
  final draft = Rxn<SelectedDocument>();

  HtmlToPdfController get _parent => Get.find<HtmlToPdfController>();
