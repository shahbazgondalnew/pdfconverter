...
import 'excel_to_pdf_controller.dart';

class ExcelEditController extends GetxController {
  late final String documentId;
  final draft = Rxn<SelectedDocument>();

  ExcelToPdfController get _parent => Get.find<ExcelToPdfController>();
