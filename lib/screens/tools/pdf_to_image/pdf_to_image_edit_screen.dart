...
class PdfToImageEditScreen extends GetView<PdfToImageEditController> {
  const PdfToImageEditScreen({super.key});
    ...
    return AppBackground(
      child: Scaffold(
        ...
        body: Obx(() {
          ...
          if (image == null) {
            return Center(child: Text(LocaleKeys.noImagesSelected.tr));
          }
