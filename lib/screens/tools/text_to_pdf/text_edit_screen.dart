...
class TextEditScreen extends GetView<TextEditController> {
  ...
  Widget build(BuildContext context) {
    return AppBackground(
      child: Scaffold(
        ...
        appBar: AppBar(
          title: Text(LocaleKeys.editTextPages.tr),
          actions: [
            TextButton(
        ...
        body: Obx(() {
          ...
          if (doc == null) {
            return Center(child: Text(LocaleKeys.noTextSelected.tr));
          }
          ...
          return Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text(
                  LocaleKeys.editTextPagesHint.tr,
...
class _TextPageCard extends StatelessWidget {
  const _TextPageCard({
