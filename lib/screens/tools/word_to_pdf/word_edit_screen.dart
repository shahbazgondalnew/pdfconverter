...
class WordEditScreen extends GetView<WordEditController> {
  ...
  Widget build(BuildContext context) {
    return AppBackground(
      child: Scaffold(
        ...
        appBar: AppBar(
          title: Text(LocaleKeys.editWordPages.tr),
          actions: [
            TextButton(
        ...
        body: Obx(() {
          ...
          if (doc == null) {
            return Center(child: Text(LocaleKeys.noWordSelected.tr));
          }
          ...
          return Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Text(
                  LocaleKeys.editWordPagesHint.tr,
