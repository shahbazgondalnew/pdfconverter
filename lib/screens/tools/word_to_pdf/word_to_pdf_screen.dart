...
class WordToPdfScreen extends GetView<WordToPdfController> {
  ...
  Widget build(BuildContext context) {
    return AppBackground(
      child: Scaffold(
        ...
        appBar: AppBar(
          title: Text(LocaleKeys.toolWordToPdf.tr),
        ),
        body: Obx(() {
              ...
              Expanded(
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    children: [
                      SectionCard(
                        title: LocaleKeys.selectedWordFiles.tr,
                        trailing: Text(
                          '${docs.length}',
                          style:
                        ...
                        child: SelectedDocumentGrid(
                          ...
                          emptyLabel: LocaleKeys.noWordSelected.tr,
                      ...
                      SectionCard(
                        ...
                        subtitle: LocaleKeys.wordBackgroundHint.tr,
